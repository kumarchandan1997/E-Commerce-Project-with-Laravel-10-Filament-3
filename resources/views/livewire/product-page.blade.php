          ...
          <div class="w-full pr-2 lg:w-1/4 lg:block">
              ...
              <ul>
                ...
                <li class="mb-4" wire:key="{{$cat->id}}">
                    <label for="{{$cat->slug}}" class="flex items-center dark:text-gray-400 ">
                      <input type="checkbox" id="{{$cat->slug}}" value="{{$cat->id}}" class="w-4 h-4 mr-2">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <ul>
               ...
               <li class="mb-4" wire:key="{{$bra->id}}">
                <label for="{{$bra->slug}}" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" id="{{$bra->slug}}" value="{{$bra->id}}" class="w-4 h-4 mr-2">
